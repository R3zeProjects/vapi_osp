/** @file ui.hpp
 *  @brief UI system: signals/reactions, widgets, layouts, Assistant, MathArea.
 *  Original implementation — all rights reserved. */

#ifndef VAPI_UI_UI_HPP
#define VAPI_UI_UI_HPP
