...
*Руководство актуально для версии API VAPI 0.0.1-alpha (версия в `CMakeLists.txt`, документация в `docs/`). Быстрый старт в одну страницу — [quick_start.md](quick_start.md).*
